...
let cities : string[] = ["Dublin", "Berlin", "New York", "Macca", "Dubai"];
cities.forEach((city) => {
...
let friends : string[] = ["Huzaifa", "Ghilman", "Abdul Wasey"];
...
let stringTest1 : string = "Huzaifa";
let stringTest2 : string = "huzaifa";
...
let cars : string[] = ["civic", "corolla", "bugati"];
