...
let joiningText = (text, number) => text + number;
...
let checkBothTrue = (value1, value2) => value1 && value2;
...
let sumValue = (numStr, num) => Number(numStr) + num;
console.log(sumValue("5", 2));
// Question 68: Multiplying Decimals: Create a function that accepts two decimal numbers and returns their product. Round the result to two decimal places.
let sumDecimals = (decimal1, decimal2) => Math.round((decimal1 * decimal2) * 100) / 100;
console.log(sumDecimals(23.5, 23.7));
// Question 69: Dividing and Finding the Remainder: Write a function that divides two numbers and returns both the quotient and the remainder. Use an object to return both values.
function quotientRemaindr(num1, num2) {
