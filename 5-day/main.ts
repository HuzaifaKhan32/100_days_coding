...
let guestList: string[] = ["Rovman", "Harry", "Pooran", "Bob", "Head", "Charles"]
...
let places_world : string[] = ["Berlin", "Dubai", "Macca", "New Zealand", "Australia"];
...
let guest_list: string[] = ["Rovman", "Harry", "Pooran", "Bob", "Head", "Charles"];
