...
let loggedUsers = ["Huzaifa", "Nadeem", "Admin", "Iqbal", "Ranveer"];
...
let usersList = ["Huzaifa", "Nadeem", "Admin", "Iqbal", "Ranveer"];
let newUser = ["Iqbal", "Rafiq", "Shafiq", "maRtoub"];
